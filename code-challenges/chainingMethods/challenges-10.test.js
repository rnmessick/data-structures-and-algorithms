...
const count = (target, input) => {
  // Solution code here...
  let totalCount = 0;
  input.reduce((accumulator, inputArr) =>{
    accumulator = inputArr.filter(targetExists =>{
...
let findShortest = (data) => {
  // Solution code here...
  let shortestCharacter = data.reduce((accumulator,currentValue) =>{
    if(parseInt(accumulator.height) < parseInt(currentValue.height)) return accumulator;
    return currentValue;
  });
